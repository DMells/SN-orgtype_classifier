...
def assign_org_ids_to_clusters():
    df, df_name = load_df(in_arg.dir, in_arg.datafile[:-3] + '_deduped.csv')
...
if __name__ == '__main__':
    ...
    df = deduplicate('../../' + in_arg.dir + classd_name, 'org_string','../../' + in_arg.dir + df_name + '_deduped.csv')
